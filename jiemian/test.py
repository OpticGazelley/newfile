...
appid = "85ba39a2"    #填写控制台中获取的 APPID 信息
api_secret = "ZTBmOWQxOTU2YTNiOGUwMzA2NmFjNDY1"   #填写控制台中获取的 APISecret 信息
api_key ="b75e7701e186128d65eb861c106e868d"    #填写控制台中获取的 APIKey 信息
#imagedata = open("test00.png",'rb').read()
...
text_output_path = 'E:\zhongruan\demo2\jieshou.txt'
